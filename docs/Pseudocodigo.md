INICIO
  ...
  DEFINIR TECNOLOGIAS (diccionario) con 4 opciones:
      1: IA
      2: Automatización
      3: IoT
  ...
  FUNCION PedirEntero(mensaje, minimo, maximo) DEVUELVE entero
      REPETIR
          ...
          SINO
              CONVERTIR entrada a entero -> valor
  ...
  PROCEDIMIENTO MostrarMenu()
      ...
      MOSTRAR "4. KamsayMed (Salud preventiva – caso de estudio)"
  ...
  FUNCION ClasificarNivel(score_total) DEVUELVE texto
      SI score_total >= 85 ENTONCES
          DEVOLVER "ALTO"
      SINO SI score_total >= 60 ENTONCES
          DEVOLVER "MEDIO"
      SINO
          DEVOLVER "BAJO"
      FIN SI
  ...
  FUNCION EvaluarTecnologia(opcion) DEVUELVE registro
      ...
      MOSTRAR "Selecciona contexto:"
      MOSTRAR "1. Urbano  2. Rural  3. Educación  4. Salud"
      ...
      SI nivel = "ALTO" ENTONCES
          recomendacion = "Implementar con enfoque ético y controles claros"
      SINO SI nivel = "MEDIO" ENTONCES
          recomendacion = "Implementar con educación y mitigación de riesgos"
      SINO
          recomendacion = "Evaluar viabilidad, riesgos y aceptación social"
      FIN SI
  ...
  PROCEDIMIENTO MostrarReporte(registro)
      MOSTRAR "REPORTE DE IMPACTO"
      MOSTRAR "Fecha:", registro.fecha
      MOSTRAR "Tecnología:", registro.tecnologia
      MOSTRAR "Contexto:", registro.contexto
      MOSTRAR "Impacto social:", registro.impactos.social
      MOSTRAR "Impacto económico:", registro.impactos.economico
      MOSTRAR "Impacto ético:", registro.impactos.etico
      MOSTRAR "Score total:", registro.score_total
      MOSTRAR "Nivel:", registro.nivel
      MOSTRAR "Recomendación:", registro.recomendacion
      MOSTRAR "Riesgos:"
      PARA cada riesgo en registro.riesgos HACER
          MOSTRAR "- ", riesgo
      FIN PARA
  FIN PROCEDIMIENTO
  ...
  PROCEDIMIENTO VerHistorial(historial)
      SI historial está vacío ENTONCES
          MOSTRAR "No hay historial registrado"
      SINO
          MOSTRAR "Historial (últimas 10 evaluaciones):"
          TOMAR últimos 10 registros
          PARA cada item en últimos 10 HACER
              MOSTRAR item.fecha, item.tecnologia, item.contexto, item.nivel, item.score_total
          FIN PARA
      FIN SI
  FIN PROCEDIMIENTO
  ...
  MIENTRAS opcion != 0 HACER
      ...
      SINO SI opcion está entre 1 y 4 ENTONCES
